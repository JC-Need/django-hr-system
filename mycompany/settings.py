...
TIME_ZONE = 'Asia/Bangkok'  # ✅ ตั้งเวลาเป็นกรุงเทพฯ
...
# --- ✨ ตั้งค่าระบบ Login/Logout (สำคัญมาก!) ---
LOGIN_URL = 'login'              # ถ้ายังไม่ล็อกอิน ให้ดีดมาหน้านี้
LOGIN_REDIRECT_URL = 'dashboard' # ล็อกอินเสร็จ ให้ไปหน้านี้
LOGOUT_REDIRECT_URL = 'login'    # ล็อกเอาต์เสร็จ ให้กลับมาหน้านี้